...
STANDARD_ENV_DIMS = (12,12)
DEFAULT_AGENT_LOCATION = (1,1)

WORLD_COLOR_WALL = "black"
WORLD_COLOR_CLEAN = "white"
WORLD_COLOR_RED = "red"
WORLD_COLOR_ORANGE = "orange"
WORLD_COLOR_YELLOW = "yellow"
WORLD_COLOR_GREEN = "green"
WORLD_COLOR_BUSTED = "blue"
...
class VacuumEnvironmentGUISimulator:
    ...
    def setup_images(self):
        ...
        self.images = {CLEAN: PhotoImage(file="images/blank.png"),
                       ...
                       RED:  PhotoImage(file="images/red.png"),
                       ORANGE:  PhotoImage(file="images/orange.png"),
                       YELLOW:  PhotoImage(file="images/yellow.png"),
                       GREEN:  PhotoImage(file="images/green.png"),
                       BUSTED: PhotoImage(file="images/blue.png")}
    ...
    def refresh_tile(self, x, y):
        if PLATFORM_WINDOWS:
            ...
            new_state =  WORLD_COLOR_CLEAN  if state == CLEAN\
                    else WORLD_COLOR_RED  if state == RED\
                    else WORLD_COLOR_ORANGE  if state == ORANGE\
                    else WORLD_COLOR_YELLOW  if state == YELLOW\
                    else WORLD_COLOR_GREEN  if state == GREEN\
                    else WORLD_COLOR_BUSTED   if state == BUSTED\
